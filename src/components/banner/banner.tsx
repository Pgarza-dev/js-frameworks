...
export default function Banner() {
  const NextArrow = (props: any) => {
    ...
    return (
      <div
        onClick={onClick}
        className="p-3 bg-white hover:text-lightModePrimary hover:font-bold cursor-pointer duration-200 rounded-full text-2xl items-center justify-center z-20 absolute left-1/3  bottom-10">
        <PiCaretLeftLight />
      </div>
    );
  };
  const PrevArrow = (props: any) => {
    ...
    return (
      <div
        onClick={onClick}
        className="p-3 bg-white hover:font-bold hover:text-lightModePrimary cursor-pointer duration-200 rounded-full text-2xl items-center justify-center z-20 absolute right-1/3 bottom-10">
        <PiCaretRightLight />
      </div>
    );
  };
